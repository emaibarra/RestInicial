...
//PersonaServices servicio;
    ...
    @PostMapping("")
    public ResponseEntity<?> save(@RequestBody Persona entity){ //atrapar lo que viene del body y enplantillarlo segun como lo tenga
    ...
    @PutMapping("/{id}") //casi lo mismo que el post
